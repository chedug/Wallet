...
class Wallet(models.Model):
    ...
    name = models.CharField(max_length=8, blank=False,
                            unique=True, editable=False, default=create_random_name)
...
class Transaction(models.Model):
    ...
    transfer_amount = models.DecimalField(max_digits=20, decimal_places=2,validators=[MinValueValidator(Decimal('0'))],)
    commission = models.DecimalField(max_digits=20, decimal_places=2,validators=[MinValueValidator(Decimal('0'))],)
